...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        EDA1Button = QAction('Correlation Plot', self)
        ...
        #::--------------------------------------------------
        # dropdown for Simple Linear Regression
        MLModel1Button =  QAction(QIcon(), 'Simple Linear Regression', self)
    ...
    def MLLR(self):
        #::-----------------------------------------------------------
        # This function creates an instance of the SimpleLinear Regression
        #::-----------------------------------------------------------
        dialog = SimpleLinearRegression()
        self.dialogs.append(dialog)
        dialog.show()
...
class SimpleLinearRegression(QMainWindow):
    #::----------------------
    # Implementation of Simple Linear regression using the bike share dataset
    # the methods in this class are
    #       _init_ : initialize the class
    #       initUi : creates the canvas and all the elements in the canvas
    ...
    #::--------------------------------------------------------
        ...
        self.layout = QGridLayout(self.main_widget)
        self.layout.addWidget(QLabel("Select Feature for Simple Linear Regression Subplot"))
...
class CorrelationPlot(QMainWindow):
    ...
    def update(self):
        ...
        self.ax1.set_yticks(np.arange(len(vsticks1)))
        self.ax1.set_xticks(np.arange(len(vsticks1)))
